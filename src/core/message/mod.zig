...
// 类型特化消息
pub const TypedMessage = @import("typed_message.zig").TypedMessage;
pub const MessageSizeClass = @import("typed_message.zig").MessageSizeClass;
pub const TinyMessage = @import("typed_message.zig").TinyMessage;
pub const SmallMessage = @import("typed_message.zig").SmallMessage;
pub const MediumMessage = @import("typed_message.zig").MediumMessage;
pub const LargeMessage = @import("typed_message.zig").LargeMessage;
